...
MemoryWatchModel::MemoryWatchModel(QObject* parent): QAbstractListModel(parent) {
    ...
    //m_watches.append({0x2017660, "gSmallChests", "TileEntityDefinition[8]"}); // TODO maybe only small chest?
